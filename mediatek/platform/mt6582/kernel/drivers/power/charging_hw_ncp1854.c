...
const kal_uint32 INPUT_CS_VTH_TA[]=
 {
	 CHARGE_CURRENT_550_00_MA,  CHARGE_CURRENT_600_00_MA,  CHARGE_CURRENT_700_00_MA,
	 CHARGE_CURRENT_800_00_MA,  CHARGE_CURRENT_900_00_MA,  CHARGE_CURRENT_1000_00_MA,
	 CHARGE_CURRENT_1100_00_MA, CHARGE_CURRENT_1200_00_MA,  CHARGE_CURRENT_1300_00_MA,
	 CHARGE_CURRENT_1400_00_MA, CHARGE_CURRENT_1500_00_MA,  CHARGE_CURRENT_1600_00_MA,
...
//  ncp1854_set_int_mask(0x0); //disable all interrupt
    ...
    if((ncp1854_status == 0x8) || (ncp1854_status == 0x9) || (ncp1854_status == 0xA)) //WEAK WAIT, WEAK SAFE, WEAK CHARGE
		...
		ncp1854_set_ctrl_vbat(0x2A); //4.35v
#else
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	ncp1854_set_aicl_en(0x1); //disable AICL
