...
static MSDK_SCENARIO_ID_ENUM ov2680CurrentScenarioId = MSDK_SCENARIO_ID_CAMERA_PREVIEW;
...
static void OV2680MIPI_Sensor_Init(void)
{
	...
	*/
	...
	OV2680_write_cmos_sensor(0x3820, 0xc6);
	OV2680_write_cmos_sensor(0x3821, 0x05);
