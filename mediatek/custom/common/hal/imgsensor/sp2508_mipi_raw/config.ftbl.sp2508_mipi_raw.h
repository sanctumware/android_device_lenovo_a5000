 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_SP2508_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144",      "256x144", "480x320", "512x288",      "640x480", "768x432",
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
           ...
           ITEM_AS_DEFAULT_("18000,18000"),//hanlei 
            ITEM_AS_USER_LIST_(
                //"(15000,15000)", 
                "(8000,8000)", 
                //"(24000,24000)", 
...
#if 0
    // TYD-Effect
    #include "config.tydeffect.common.inl"
#endif
//*/
    //==========================================================================
#if 0
